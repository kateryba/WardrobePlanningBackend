...
namespace WebApi.Controllers
{
    ...
    {
        const string ConnectionString = "Server=HOME-PC\\SQLEXPRESS;Database=WardrobePlanning;MultipleActiveResultSets=true;User Id=sa;Password=1;";
        //private static readonly int[] Sizes = new[]
        //{
        //    56, 62, 68, 74, 80, 86, 92, 98, 104, 5, 6, 7 , 8, 10, 12, 14, 16
        //};
        ...
        //static FamilyMembersController()
        //{
        //Members = Enumerable.Range(0, Names.Length).Select(index => new FamilyMember
        //{
        //    ID = index,
        //    Name = Names[index],
        //    Age = _rng.Next(0, 18),
